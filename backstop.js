...
const clickSelector = (clickSelector) => composeScenario.bind(null, { clickSelector, onReadyScript: 'clickSelector.js', delay: 2000 });
...
const scenarios = [
  ...
  // TODO CHECK
  clickSelector('.dl-trigger')({ path: '/', label: 'Explorer', delay: 5000 }),
  ...
  // TODO CHECK
  contentOnly(clickSelector('.dropdown-toggle')({ path: '/pages/5/edit/#dropdown-toggle' })),
  // TODO CHECK
  ...
  // clickSelector('.submenu-trigger')({ path: '/' }),
